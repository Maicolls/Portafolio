...
import interfaz from "../../public/Skills/interfaz 1.png";
import interfaz2 from "../../public/Skills/interfaz2.jpg";
...
const projects = [
  ...
  },
  {
    title: "PsicoAxioma",
    description:
      "PsicoAxioma es una app móvil creada con React Native, que integra IA de HumeAI para ofrecer apoyo psicológico. Incluye un escáner emocional, un diario emocional y acceso a líneas de atención psicológica en Bogotá. (dale click al icono para ver el repositorio)",
    image: interfaz2,
...
const Projects = () => (
  <>
    <div className="pt-11" id="projects">
      ...
      <div className='flex justify-center flex-wrap gap-10 p-6' id="projects">
        {projects.map((project, idx) => (
          <div key={idx} className="max-w-sm rounded overflow-hidden shadow-lg transition-all duration-300 cursor-pointer hover:shadow-xl hover:shadow-gray-400 hover:scale-105">
            ...
            <div className="flex justify-center space-x-3 mt-1 text-4xl pb-4">
              {project.technologies.map((icon) => (
                <span key={icon}>{techIcons[icon]}</span>
              ))}
            </div>
          </div>
        ))}
