...
import { ShineBorder } from "../../lib/magicui/shine-border";

const ContacMe = () => {
    return (

    <>
        <div className="container grid gap-8 px-6 py-12 mx-auto lg:grid-cols-4" id="contact">
            <div>
                <p className="font-medium text-white"> Contacta conmigo. </p>
                    <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl text-yellow-400"> Recuerda Sin Junior no hay Senior </h1>
            ...
            <div className="relative p-6 rounded-xl shadow-lg 
                ...
                flex flex-col items-center overflow-hidden">
                    <ShineBorder 
                        shineColor={["#facc15", "#fde047", "#facc15"]} 
                        borderWidth={2} 
                        duration={9}
                ...
                <span className="px-4 py-2 bg-red-500 text-white rounded-full shadow hover:bg-red-600 transition-colors">
                    {contact[0].email}
                </span>
            </div>
            ...
            <div className="relative p-6 rounded-xl shadow-lg 
                ...
                flex flex-col items-center overflow-hidden">
                    <ShineBorder 
                        shineColor={["#22c55e", "#16a34a", "#22c55e"]}
                        borderWidth={2} 
                        duration={9}
                        className="rounded-xl"
                    />
            ...
            <div className="relative p-5 rounded-xl shadow-lg 
                bg-transparent backdrop-blur-md 
                flex flex-col items-center overflow-hidden">
                    <ShineBorder 
                        shineColor={["#1d4ed8", "#2563eb", "#1d4ed8"]} 
                        borderWidth={2} 
                        duration={9}
                        className="rounded-xl"
                    />
