...
const Contac = [
    {
        ...
        description:"No dudes en contatar me sientre estare desponible",
    ...
    },
    {
        ...
        phone:"(+57) 314 281 2093"
    },
    {
        title:"Mi LinkedIn",
        description:"Hagamos match para conectar",
        linkedin:"https://www.linkedin.com/in/maycol-gutierrez/"
    }
];
...
const ContacMe = () => {
    return (   
        <div className="container grid gap-8 px-6 py-12 mx-auto lg:grid-cols-3" id="contact">
            <div>
                <p className="font-medium text-blue-500"> Contacta Me </p>

                <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl"> Recuerda Sin Junior no hay Senior </h1>

                <p className="mt-3 text-gray-500 dark:text-gray-400"> Sigustas podemos agendar una entrevista con gusto</p>
            </div>
